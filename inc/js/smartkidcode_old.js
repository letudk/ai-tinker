...
document.addEventListener("DOMContentLoaded", (event) => {
	...
	/* double click */
	for (var pres = document.querySelectorAll("code"), i = 0; i < pres.length; i++) pres[i].addEventListener("dblclick", function() {
	    var e = getSelection(),
